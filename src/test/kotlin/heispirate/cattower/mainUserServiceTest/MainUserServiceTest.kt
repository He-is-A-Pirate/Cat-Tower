...
////            TODO(검증 미적용 검증 적용시 에라가 나는지 확인해볼것)
////        }
    @Test
    fun `회원정보 조회 정상`(){
    //GIVEN
    ...
    val userId = 1L
    //WHEN
    val user = mainUserService.getUser(userId)

    //THEN
    user.nickname shouldBe "이율"
    user.email shouldBe "njunju777@nate.com"
    user.aboutMe shouldBe "하위"
    user.phoneNumber shouldBe "01077777777"
